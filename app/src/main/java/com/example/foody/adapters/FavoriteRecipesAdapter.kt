...
class FavoriteRecipesAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
         ...
         */
        holder.itemView.favoritRecipesRowLayout.setOnClickListener {
            if (multiSelection) {
         ...
         * Long Click Listener
         */
        holder.itemView.favoritRecipesRowLayout.setOnLongClickListener {
            if (!multiSelection) {
                multiSelection = true
    ...
    private fun changeRecipeStyle(holder: MyViewHolder, backgroundColor: Int, strokeColor: Int) {
        holder.itemView.favoritRecipesRowLayout.setBackgroundColor(
